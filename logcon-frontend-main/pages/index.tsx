        ...
        <Wrapper>
          <BoxWrapper>
            <Column $gap={32}>
              ...
              <SubTitle>2024. 1. 18. 11:00 ~ 2024. 1. 19. 00:00</SubTitle>
              <Button href="https://discord.gg/A5uUsrPW">
                디스코드 서버 참가
            ...
            <Column $gap={17}>
              ...
              <ContentRow>
                ...
                <RankText $color="#C7CCD9">삼성 버즈3</RankText>
              </ContentRow>
              <ContentRow>
...
const Button = styled(Link)`
  ...
  gap: 8px;
  border-radius: 8px;
  background: var(--2024-Logcon-40, #3A4542);
  color: var(--2024-Logcon-80, #F2F2F2);
`;
